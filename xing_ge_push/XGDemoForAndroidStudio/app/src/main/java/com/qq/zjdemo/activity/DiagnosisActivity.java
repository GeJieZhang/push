package com.qq.zjdemo.activity;
...
import com.qq.zjdemo.bean.ClickAction;
import com.qq.zjdemo.bean.Style;
import com.qq.zjdemo.bean.TimeInterval;
import com.qq.zjdemo.common.CommonWorkingThread;
import com.qq.zjdemo.common.ExtendedListView;
import com.qq.zjdemo.common.ExtendedListView.OnPositionChangedListener;
import com.qq.zjdemo.common.XingeApp;
...
public class DiagnosisActivity extends Activity implements OnPositionChangedListener {
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            com.qq.zjdemo.bean.Message message = new com.qq.zjdemo.bean.Message();
            message.setType(com.qq.zjdemo.bean.Message.TYPE_NOTIFICATION);
